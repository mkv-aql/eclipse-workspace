 ...
 *
 */
public class BMI_Calculation_SimIO_1_42 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		/* 
		//BMI Calculation (Must calculate each list for each names), in a loop
		float BMI = ggw/(ggh*ggh);
